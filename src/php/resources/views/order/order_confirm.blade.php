...
<div class="container">
    ...
    <form action="{{ route('order.buy') }}" method="POSt">
        @csrf
        <div class="row">
            <div class="table-responsive col-lg-offset-6 col-lg-6 col-md-offset-1 col-md-10 col-sm-10 col-xs-12">
                ...
                <table class="table table-striped item-list-table">
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <input type="text" name='destination_zipcode' id="zip" />&nbsp;&nbsp;<button
