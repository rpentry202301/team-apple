            ...
            <div class=“container-fluid”>
                ...
                <div class=“navbar-header”>
                    ...
                    <a class=“navbar-brand” href=“item_list_pizza.html”>
                        <!-- 企業ロゴ -->
                        <img a    lt=“main log” src=“../images/header_logo.png” height=“35" />
                    </a>
                </div>
                        ...
                        <tbody>
                            @foreach ($items as $item)
                                ...
                                <tr>
                                    <td>
                                        <div class=“center”>
                                            <img src=“../images/1.jpg” class=“img-responsive img-rounded
                                                item-img-center” width=“100” height=“300" /><br />
                                            {{ $item->item->name }}
                                        </div>
                                    </td>
                                    <td>
                                        <span
                                            class=“price”>&nbsp;{{ $item->size }}</span>&nbsp;&nbsp;{{ $item->item->price_m }}円
                                        &nbsp;&nbsp;{{ $item->quantity }}個
                                    </td>
                                    <td>
