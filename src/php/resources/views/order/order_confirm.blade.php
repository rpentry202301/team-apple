                                        ...
                                        <div class="row">
                                            <div class="col-sm-12">
                                                <label class="control-label" style="color: red"
                                                    ...
                                                    <div class="col-sm-5">
                                                        <input type="date" name="delivery_date" id="name" class="form-control input-sm" />
                                                    </div>
                                                    </div>
                                                    <div class="row">
                                                        <div class="col-sm-12">
                                                            <label class="radio-inline">
                                                                <input type="radio" name="delivery_time" checked="checked" value="10:00:00" />
                                                                10時
                                                            </label>
                                                            <label class="radio-inline">
                                                                        ...
                                                                        <td colspan="2">
                                                                            <div class="row">
                                                                                <div class="col-8 offset-2">
                                                                                    <div class="card-form-alert alert alert-danger" role="alert" style="display: none">
                                                                                    </div>
