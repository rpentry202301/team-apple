        ...
        <div class="row">
            <div class="col-lg-offset-4">
                <i class="fas fa-ticket-alt">
                    <a style="color: white" href="{{route('order.coupon-only')}}">クーポンをお持ちの方はこちら</a>
                </i><br>

                @if(isset( $message ))
                <h4>
                    <p class="text-warning" id="coupon-message">*****{{$message}}*****</p>
                </h4>
                @endif

                @if(isset( $total_price ))
                <h4>
                    <p class="text-warning" id="coupon-message">現在の価格:{{$total_price}}円</p>
                </h4>
                @endif

                @if(isset( $discountPrice ))
                <h4>
                    <p class="text-danger" id="coupon-message"> 割引額：{{$discountPrice}}円</p>
                </h4>
                @endif

                @if(isset( $totalPrice ))
                <h4>
                    <p class="text-danger" id="coupon-message"> クーポン適応後の価格：{{$totalPrice}}円</p>
                </h4>
                @endif
            </div>
        </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    ...
                                    <input type="text" name='destination_zipcode' id="zip"
                                        ...
                                        class="btn-primary api-address" type="button"
                                        style="margin-top: 10px">住所検索</button>
                                </td>
                            </tr>
                            <tr>
                                <td>
                                    ...
                                    <div class="row">
                                        ...
                                        <div id="credit-card-info" style="display: none;">
                                            ...
                                            <script src="https://checkout.pay.jp/" class="payjp-button"
                                                data-key="{{ config('payjp.public_key') }}" data-text="カード情報を入力"
                                                data-submit-text="購入する"></script>
                                        </div>
                                    </div>
                                </td>
                            </tr>
